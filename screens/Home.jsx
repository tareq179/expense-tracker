...
import {COLORS,FONTS,icons,SIZES} from '../src/components'
    ...
    const renderNavBar = () => {
        return (
            <View style={{
                ...
                <TouchableOpacity 
                style={{
                    justifyContent:'center',width:50, alignItems:'flex-end'
                }}
        ...
        return(
            <View style={{
                ...
                <View>
                    ...
                    <Text style={{color:COLORS.darkgray,...FONTS.h3}}>Summary (provate)</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', marginTop:SIZES.padding, alignItems:'center' }}>
                    ...
                    <View style={{marginLeft: SIZES.padding}}>
                        <Text style={{color:COLORS.primary,...FONTS.h3}}>23 Nov, 2022</Text>
